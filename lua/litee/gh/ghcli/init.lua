...
local function async_request(args, on_read, paginate, page)
    local buffer = ""
        ...
        if data == nil then
            ...
            if paginate then
                if #data == 100 then
                    ...
                    async_request(args, on_read, paginate, page+1)
                    return
                end
            end

            on_read(false, paginated_data)
        end
    end)
